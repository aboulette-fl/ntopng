local lang = {
  ...
  ["analyze_pcap_descr"] = "Please select a pcap file to be uploadede to ntopng for analysis",
  ...
  ["ipv6"] = "IPv6",
  ["issuerDN"] = "IssuerDN",
  ["ja3.client_hash"] = "JA3 Client Hash",
  ["ja3.server_cipher"] = "JA3 Server Cipher",
  ["ja3.server_hash"] = "JA3 Server Hash",
  ["ja3.server_unsafe_cipher"] = "Cipher State",
  ...
  ["notAfter"] = "TLS Cert. Validity To",
  ["notBefore"] = "TLS Cert. Validity From",
  ...
  ["waiting_for_clickhouse_msg"] = "ClicHouse database did not start correctly: please check the ntopng startup log and fix the reported problems.",
  ["warning"] = "Warning",
  ["week"] = "Week",
  ["welcome"] = "Welcome",
  ...
  ["alert_messages"] = {
    ...
    ["device_has_connected"] = "An unexpected device <a href=\"%{device_url}\">%{device}</a> %{event} to the interface <a href=\"%{if_url}\">%{if_name}</a>. Check <a href=\"%{exclusion_url}\">here</a> to check the allowed/denied devices.",
    ...
    ["host_alert_misc_traffic"] = "Misc traffic exceeded by %{entity} [%{value} %{op} %{threshold}]",
    ["host_alert_p2p_traffic"] = "P2P traffic exceeded by %{entity} [%{value} %{op} %{threshold}]",
    ["host_alert_pkt_threshold"] = "Packet threshold exceeded by %{entity} [%{value} %{op} %{threshold}]",
    ...
    ["scan_detected"] = "%{entity} is a scannet [%{value} &gt; %{threshold} scan attempts]",
  ...
  ["alerts_dashboard"] = {
    ...
    ["binary_application_transfer"] = "Binary Application Transfer",
    ...
    ["debug"] = "Debug",
    ["device_connection_disconnection"] = "Unexpected Connection/Disconnection",
    ...
    ["host_alert_misc_traffic"] = "Misc Traffic",
    ...
    ["known_proto_on_non_std_port"] = "App. on Non-Std Port",
    ...
    ["ndpi_tls_selfsigned_certificate_title"] = "TLS Cert. Self-signed",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["alert_misc_description"] = "Trigger an alert when the Layer 2 bytes delta (sent + received) for Misc traffic exceeds the threshold",
    ...
    ["misc_traffic"] = "Misc Traffic Alert",
  ...
  ["checks"] = {
    ...
    ["device_connection_disconnection_description"] = "Trigger an alert when a denied device connects or when an allowed device disconnects from the network.",
    ["device_connection_disconnection_title"] = "Unexpected Device Connected/Disconnected",
  ...
  ["edit_check"] = {
    ["add_device_exclusion"] = "Add Allowed Devices",
    ["add_device_exclusion_list_notes"] = "A list of allowed MAC addresses, one per row",
    ["add_device_exclusion_message"] = "Allowed Devices List",
    ["add_device_exclusion_notes"] = "all devices set here are going to override the already know statuses (If a device was denied, now is set to allowed)",
    ["author"] = "Author",
    ["category"] = "Category",
    ...
    ["trigger_device_disconnected_alert_descr"] = "(Note: Trigger an alert when the allowed devices disconnect from the interface)",
    ["hooks_name"] = {
      ["5mins"] = "5 Minutes",
      ["all"] = "All",
      ["day"] = "Daily",
  ...
  ["endpoint_notifications"] = {
    ...
    ["num_drops"] = "Drops",
    ["num_uses"] = "Uses",
    ["recipient_category"] = "Check Categories",
    ["recipient_entities"] = "Check Entities",
  ...
  ["entity_thresholds"] = {
    ...
    ["icmp_flood_description"] = "Trigger an alert when the number of sent/received ICMP Flows/sec exceeds the threshold",
    ...
    ["scan_detection_title"] = "Scan Detection Alert",
  ...
  ["flow_checks_config"] = {
    ...
    ["tcp_connection_no_answer_title"] = "TCP Conn. with No Answer",
    ...
    ["tcp_issues_generic"] = "TCP Retransm. Issues",
  ...
  ["flow_devices"] = {
    ...
    ["note_condition_2"] = "2) SNMP and flow probes timeseries must be enabled from the from the <A HREF=\"%{url}\"><i class=\"fas fa-flask\"></i> Preferences</A>",
    ...
    ["note_zmq_fields1"] = "Flow probes are determined using ZMQ fields %%EXPORTER_IPV4_ADDRESS and %%NPROBE_IPV4_ADDRESS. When both fields are available, the former takes precedence over the latter",
    ["note_zmq_fields2"] = "Flow probes interfaces are determined using ZMQ fields %%INPUT_SNMP and %%OUTPUT_SNMP",
  ...
  ["flow_risk"] = {
    ...
    ["ndpi_binary_application_transfer_descr"] = "Trigger an alert when a binary application is Downloaded/Uploaded",
    ...
    ["ndpi_tls_cert_validity_too_long"] = "TLS certificate validity longer than 13 months",
    ...
    ["ndpi_tls_suspicious_esni_usage"] = "Susp. TLS ESNI Usage",
    ["ndpi_tls_suspicious_extension"] = "TLS Susp. Extension",
  ...
  ["graphs"] = {
    ...
    ["iface_traffic_rx_behavior"] = "Behaviour: Traffic RX",
    ["iface_traffic_tx_behavior"] = "Behaviour: Traffic TX",
  ...
  ["if_stats_overview"] = {
    ...
    ["zmq_encryption_public_key_note"] = "If you are using nProbe as probes, please add --zmq-encryption-key '%{key}' to the nProbe configuration.",
  ...
  ["manage_users"] = {
    ...
    ["allow_historical_flow"] = "Allow Historical Flow",
    ["allow_historical_flow_descr"] = "Allow the user to use the Historical Flow page",
  ...
  ["prefs"] = {
    ...
    ["devices_behaviour"] = "Devices Behaviour",
    ...
    ["devices_learning_period_description"] = "Configure the learning period for Device/MAC Address Tracking.",
    ["devices_learning_period_title"] = "Device/MAC Address Tracking Learning Period",
    ...
    ["dump_frequency_title"] = "Flow Dump Frequency",
    ...
    ["flows_and_alerts_data_retention_descr"] = "Number of days to keep dumped flows (if enabled) and alerts. Default: 30 days.",
    ...
    ["n2n_supernode_description"] = "The address of the <a class='ntopng-external-link' href=\"%{url}\">n2n</a> <i class=\"fas fa-external-link-alt\"></i> supernode. Set up your own supernode in order to have a fully private remote access.<br><b>NOTE</b>: this change will have affect only after Remote Assistance restart.",
    ...
    ["toggle_flow_rrds_description"] = "Toggle the creation of bytes timeseries for each port of the remote device as received through ZMQ (e.g. sFlow/NetFlow/SNMP).<br>For non sFlow probes, %%INPUT_SNMP and %%OUTPUT_SNMP must appear into the nprobe template.",
    ["toggle_flow_rrds_title"] = "Flow Probes",
    ...
    ["toggle_intranet_traffic_rrds_title"] = "Network Matrix",
    ...
    ["toggle_observation_points_rrds_description"] = "Toggle Observation Points timeseries. No timeseries is created if there are no observation points.<br><b>Note:</b> The Observation Point timeseries L-7 applications preferences are the same of the Interface; so if no timeseries is created for the interface L-7 applications then no timeseries is created for the Observation Points L-7 applications.",
    ...
    ["ts_and_stats_data_retention_descr"] = "Number of days to keep timeseries and stats (e.g. Top Talkers). Default: 30 days.<br><b>Note:</b> If InfluxDB is currently used, to change the retention policy correctly, ntopng restart is needed.",
