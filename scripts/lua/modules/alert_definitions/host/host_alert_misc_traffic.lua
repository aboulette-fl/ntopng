...
local host_alert_misc_traffic = classes.class(alert)

-- ##############################################

host_alert_misc_traffic.meta = {
  alert_key = host_alert_keys.host_alert_misc_traffic,
  i18n_title = "alerts_dashboard.host_alert_misc_traffic",
...
function host_alert_misc_traffic:init(metric, value, operator, threshold)
...
function host_alert_misc_traffic.format(ifid, alert, alert_type_params)
  local alert_consts = require("alert_consts")
  local entity = alert_consts.formatHostAlert(ifid, alert["ip"], alert["vlan_id"])

  return i18n("alert_messages.host_alert_misc_traffic", {
    entity = entity,
...
-- @param alert_type_params Table `alert_type_params` as built in the `:init` method
-- @return A human-readable string
function host_alert_misc_traffic.filter_to_past_flows(ifid, alert, alert_type_params)
   local res = {}
...
return host_alert_misc_traffic
