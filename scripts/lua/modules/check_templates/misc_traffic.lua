...
local misc_traffic = classes.class(check_template)
...
function misc_traffic:init(check)
   -- Call the parent constructor
   self.super:init(check)
end

function misc_traffic:parseConfig(conf)
   return http_lint.validateListItems(self._check, conf)
end

-- #######################################################

function misc_traffic:describeConfig(hooks_conf)
